      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
          ...
          <div className="flex gap-4 flex-col md:flex-row">
            <input
              ...
              className="flex-1 p-3 border rounded-xl bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 outline-none transition"
              value={catTitle}
            ...
            <button
              ...
              disabled={loading}
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl flex items-center justify-center gap-2 transition shadow-md disabled:opacity-50"
            >
              <FaPlus /> افزودن
            </button>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <select
              className="p-3 border rounded-xl bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:ring-2 focus:ring-green-500 outline-none"
            ...
            <button
              ...
              disabled={loading}
              className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-xl flex items-center justify-center gap-2 transition shadow-md disabled:opacity-50"
            >
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
          ...
          {categories.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {categories.map((cat) => (
                <div key={cat.id} className="border dark:border-gray-600 rounded-xl p-4 bg-gray-50 dark:bg-gray-700/50 hover:shadow-md transition">
                  <div className="flex justify-between items-center mb-3">
                    <span className="font-bold text-xl text-gray-800 dark:text-white">{cat.title}</span>
                    <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">دسته اصلی</span>
                  </div>
                  
                  {cat.SubCategories && cat.SubCategories.length > 0 ? (
                    <div className="mr-4 border-r-2 border-gray-300 dark:border-gray-500 pr-4 space-y-2">
                      {cat.SubCategories.map((sub) => (
                        <div key={sub.id} className="flex items-center gap-2 text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800 p-2 rounded-lg border dark:border-gray-600 text-sm">
